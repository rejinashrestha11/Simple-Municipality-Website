...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  if ($name_error == "" && $address_error == "" && $ownername_error == "" && $establisheddate_error == "" && $wardnumber_error == ""){
		...
		$sql = "UPDATE industries SET name = ? , address = ?, ownername = ?, establisheddate = ?, wardnumber = ? WHERE id = ?";
    ...
    <section class="content container-fluid">
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Edit Industry Info</h3>
        </div>
          <!-- /.box-header -->
            <div class="box-body no-padding">
                ...
                <div>
            			...
            			<a href = "indlist.php" class="btn btn-danger">Cancel</a>
            		</div>
                <br>
                <br>
                </form>
