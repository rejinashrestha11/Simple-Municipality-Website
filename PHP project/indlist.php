...
<!-- Content Wrapper. Contains page content -->
  <div class="content">
    ...
    <section class="content">
      ...
      <br>
      <a href = "industry.php" class = "btn btn-success">Add Industry</a>
    </section>
    <br><br>
    <!-- Main content -->
                ...
                if($result = $conn->query($sql)) {
                  if($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                      ...
                      echo "<td>";
                      echo "<a href = 'industryview.php?id=" . $row['id'] . "'><i class= 'fa fa-eye'></i></a> | ";
                      echo "<a href = 'indedit.php?id=" . $row['id'] . "'><i class= 'fa fa-edit'></i></a> | ";
                      echo "<a href = 'deleteind.php?id=" . $row['id'] . "'><i class= 'fa fa-trash'></i></a> | ";
                      echo "</td>";
                      echo "</tr>";
                    }
                    echo "</table>";
